...
#include "lionexplorer_compactmodesettings.h"
#include "lionexplorer_contentdisplaysettings.h"
#include "lionexplorer_detailsmodesettings.h"
#include "lionexplorer_generalsettings.h"
#include "lionexplorer_iconsmodesettings.h"
...
Lion ExplorerViewContainer::Lion ExplorerViewContainer(const QUrl &url, QWidget *parent)
    : QWidget(parent)
    , m_topLayout(nullptr)
    , m_urlNavigator{new Lion ExplorerUrlNavigator(url)}
    ...
    , m_grabFocusOnUrlChange{true}
{
    ...
    if (getuid() == 0) {
        ...
        showMessage(i18n("Running Lion Explorer as root can be dangerous. Please be careful."), KMessageWidget::Warning);
    }
#endif
    ...
    connect(m_filterBar, &FilterBar::filterChanged, this, &Lion ExplorerViewContainer::setNameFilter);
    connect(m_filterBar, &FilterBar::filterModeChanged, this, &Lion ExplorerViewContainer::setFilterMode);
    connect(m_filterBar, &FilterBar::caseSensitiveChanged, this, &Lion ExplorerViewContainer::setFilterCaseSensitive);
    connect(m_filterBar, &FilterBar::closeRequest, this, &Lion ExplorerViewContainer::closeFilterBar);
    connect(m_filterBar, &FilterBar::focusViewRequest, this, &Lion ExplorerViewContainer::requestFocus);

    // Initialize the main view
    m_view = new Lion ExplorerView(url, this);
    connect(m_view, &Lion ExplorerView::urlChanged, m_filterBar, &FilterBar::clearIfUnlocked);
    connect(m_view, &Lion ExplorerView::urlChanged, m_messageWidget, &KMessageWidget::hide);
    ...
    connect(m_view, &Lion ExplorerView::urlChanged, m_urlNavigator.get(), &Lion ExplorerUrlNavigator::setLocationUrl);
    connect(m_urlNavigator.get(), &Lion ExplorerUrlNavigator::urlChanged, this, &Lion ExplorerViewContainer::slotUrlNavigatorLocationChanged);
    connect(m_urlNavigator.get(), &Lion ExplorerUrlNavigator::urlAboutToBeChanged, this, &Lion ExplorerViewContainer::slotUrlNavigatorLocationAboutToBeChanged);
    connect(m_urlNavigator.get(), &Lion ExplorerUrlNavigator::urlSelectionRequested, this, &Lion ExplorerViewContainer::slotUrlSelectionRequested);
    connect(m_view, &Lion ExplorerView::writeStateChanged, this, &Lion ExplorerViewContainer::writeStateChanged);
    connect(m_view, &Lion ExplorerView::requestItemInfo, this, &Lion ExplorerViewContainer::showItemInfo);
    connect(m_view, &Lion ExplorerView::itemActivated, this, &Lion ExplorerViewContainer::slotItemActivated);
    connect(m_view, &Lion ExplorerView::fileMiddleClickActivated, this, &Lion ExplorerViewContainer::slotfileMiddleClickActivated);
    connect(m_view, &Lion ExplorerView::itemsActivated, this, &Lion ExplorerViewContainer::slotItemsActivated);
    connect(m_view, &Lion ExplorerView::redirection, this, &Lion ExplorerViewContainer::redirect);
    connect(m_view, &Lion ExplorerView::directoryLoadingStarted, this, &Lion ExplorerViewContainer::slotDirectoryLoadingStarted);
    connect(m_view, &Lion ExplorerView::directoryLoadingCompleted, this, &Lion ExplorerViewContainer::slotDirectoryLoadingCompleted);
    connect(m_view, &Lion ExplorerView::directoryLoadingCanceled, this, &Lion ExplorerViewContainer::slotDirectoryLoadingCanceled);
    connect(m_view, &Lion ExplorerView::itemCountChanged, this, &Lion ExplorerViewContainer::delayedStatusBarUpdate);
    connect(m_view, &Lion ExplorerView::selectionChanged, this, &Lion ExplorerViewContainer::delayedStatusBarUpdate);
    connect(m_view, &Lion ExplorerView::errorMessage, this, &Lion ExplorerViewContainer::slotErrorMessageFromView);
    connect(m_view, &Lion ExplorerView::urlIsFileError, this, &Lion ExplorerViewContainer::slotUrlIsFileError);
    connect(m_view, &Lion ExplorerView::activated, this, &Lion ExplorerViewContainer::activate);
    connect(m_view, &Lion ExplorerView::hiddenFilesShownChanged, this, &Lion ExplorerViewContainer::slotHiddenFilesShownChanged);
    connect(m_view, &Lion ExplorerView::sortHiddenLastChanged, this, &Lion ExplorerViewContainer::slotSortHiddenLastChanged);
    connect(m_view, &Lion ExplorerView::currentDirectoryRemoved, this, &Lion ExplorerViewContainer::slotCurrentDirectoryRemoved);

    // Initialize status bar
    m_statusBar = new Lion ExplorerStatusBar(this);
    m_statusBar->setUrl(m_view->url());
    m_statusBar->setZoomLevel(m_view->zoomLevel());
    connect(m_view, &Lion ExplorerView::urlChanged, m_statusBar, &Lion ExplorerStatusBar::setUrl);
    connect(m_view, &Lion ExplorerView::zoomLevelChanged, m_statusBar, &Lion ExplorerStatusBar::setZoomLevel);
    connect(m_view, &Lion ExplorerView::infoMessage, m_statusBar, &Lion ExplorerStatusBar::setText);
    connect(m_view, &Lion ExplorerView::operationCompletedMessage, m_statusBar, &Lion ExplorerStatusBar::setText);
    connect(m_view, &Lion ExplorerView::statusBarTextChanged, m_statusBar, &Lion ExplorerStatusBar::setDefaultText);
    connect(m_view, &Lion ExplorerView::statusBarTextChanged, m_statusBar, &Lion ExplorerStatusBar::resetToDefaultText);
    connect(m_view, &Lion ExplorerView::directoryLoadingProgress, m_statusBar, [this](int percent) {
        m_statusBar->showProgress(i18nc("@info:progress", "Loading folder…"), percent);
    });
    connect(m_view, &Lion ExplorerView::directorySortingProgress, m_statusBar, [this](int percent) {
        m_statusBar->showProgress(i18nc("@info:progress", "Sorting…"), percent);
    });
    connect(m_statusBar, &Lion ExplorerStatusBar::stopPressed, this, &Lion ExplorerViewContainer::stopDirectoryLoading);
    connect(m_statusBar, &Lion ExplorerStatusBar::zoomLevelChanged, this, &Lion ExplorerViewContainer::slotStatusBarZoomLevelChanged);
    connect(m_statusBar, &Lion ExplorerStatusBar::showMessage, this, [this](const QString &message, KMessageWidget::MessageType messageType) {
        showMessage(message, messageType);
    });
    connect(m_statusBar, &Lion ExplorerStatusBar::widthUpdated, this, &Lion ExplorerViewContainer::updateStatusBarGeometry);
    connect(m_statusBar, &Lion ExplorerStatusBar::urlChanged, this, &Lion ExplorerViewContainer::updateStatusBar);
    connect(this, &Lion ExplorerViewContainer::showFilterBarChanged, this, &Lion ExplorerViewContainer::updateStatusBar);

    m_statusBarTimer = new QTimer(this);
    m_statusBarTimer->setSingleShot(true);
    m_statusBarTimer->setInterval(300);
    connect(m_statusBarTimer, &QTimer::timeout, this, &Lion ExplorerViewContainer::updateStatusBar);

    KIO::FileUndoManager *undoManager = KIO::FileUndoManager::self();
    connect(undoManager, &KIO::FileUndoManager::jobRecordingFinished, this, &Lion ExplorerViewContainer::delayedStatusBarUpdate);
    ...
    connect(m_statusBar, &Lion ExplorerStatusBar::modeUpdated, this, [this]() {
    ...
    // this happens here and not in Lion ExplorerView as Lion ExplorerviewContainer and Lion ExplorerView are not in the same build target ATM
    connect(ContentDisplaySettings::self(), &KCoreConfigSkeleton::configChanged, m_view, &Lion ExplorerView::reload);

    KFilePlacesModel *placesModel = Lion ExplorerPlacesModelSingleton::instance().placesModel();
    connect(placesModel, &KFilePlacesModel::dataChanged, this, &Lion ExplorerViewContainer::slotPlacesModelChanged);
    connect(placesModel, &KFilePlacesModel::rowsInserted, this, &Lion ExplorerViewContainer::slotPlacesModelChanged);
    connect(placesModel, &KFilePlacesModel::rowsRemoved, this, &Lion ExplorerViewContainer::slotPlacesModelChanged);
...
Lion ExplorerViewContainer::~Lion ExplorerViewContainer() = default;

QUrl Lion ExplorerViewContainer::url() const
{
    return m_view->url();
}

KFileItem Lion ExplorerViewContainer::rootItem() const
{
    return m_view->rootItem();
}

void Lion ExplorerViewContainer::setActive(bool active)
{
...
bool Lion ExplorerViewContainer::isActive() const
{
    return m_view->isActive();
}

void Lion ExplorerViewContainer::setGrabFocusOnUrlChange(bool grabFocus)
{
    m_grabFocusOnUrlChange = grabFocus;
}

const Lion ExplorerStatusBar *Lion ExplorerViewContainer::statusBar() const
{
    return m_statusBar;
}

Lion ExplorerStatusBar *Lion ExplorerViewContainer::statusBar()
{
    return m_statusBar;
}

const Lion ExplorerUrlNavigator *Lion ExplorerViewContainer::urlNavigator() const
{
    return m_urlNavigatorConnected;
}

Lion ExplorerUrlNavigator *Lion ExplorerViewContainer::urlNavigator()
{
    return m_urlNavigatorConnected;
}

const Lion ExplorerUrlNavigator *Lion ExplorerViewContainer::urlNavigatorInternalWithHistory() const
{
    return m_urlNavigator.get();
}

Lion ExplorerUrlNavigator *Lion ExplorerViewContainer::urlNavigatorInternalWithHistory()
{
    return m_urlNavigator.get();
}

const Lion ExplorerView *Lion ExplorerViewContainer::view() const
{
    return m_view;
}

Lion ExplorerView *Lion ExplorerViewContainer::view()
{
    return m_view;
}

void Lion ExplorerViewContainer::connectUrlNavigator(Lion ExplorerUrlNavigator *urlNavigator)
{
    ...
    connect(urlNavigator, &Lion ExplorerUrlNavigator::urlChanged, m_urlNavigator.get(), &Lion ExplorerUrlNavigator::setLocationUrl);
    connect(urlNavigator, &Lion ExplorerUrlNavigator::urlsDropped, this, [=, this](const QUrl &destination, QDropEvent *event) {
        m_view->dropUrls(destination, event, urlNavigator->dropWidget());
    });
    // Aside from these, only visual things need to be connected.
    connect(m_view, &Lion ExplorerView::urlChanged, urlNavigator, &Lion ExplorerUrlNavigator::setLocationUrl);
    connect(urlNavigator, &Lion ExplorerUrlNavigator::activated, this, &Lion ExplorerViewContainer::activate);
    connect(urlNavigator, &Lion ExplorerUrlNavigator::requestToLoseFocus, m_view, [this]() {
        m_view->setFocus();
    });
...
void Lion ExplorerViewContainer::disconnectUrlNavigator()
{
    if (!m_urlNavigatorConnected) {
        return;
    }

    disconnect(m_urlNavigatorConnected, &Lion ExplorerUrlNavigator::urlChanged, m_urlNavigator.get(), &Lion ExplorerUrlNavigator::setLocationUrl);
    disconnect(m_urlNavigatorConnected, &Lion ExplorerUrlNavigator::urlsDropped, this, nullptr);
    disconnect(m_view, &Lion ExplorerView::urlChanged, m_urlNavigatorConnected, &Lion ExplorerUrlNavigator::setLocationUrl);
    disconnect(m_urlNavigatorConnected, &Lion ExplorerUrlNavigator::activated, this, &Lion ExplorerViewContainer::activate);
    disconnect(m_urlNavigatorConnected, &Lion ExplorerUrlNavigator::requestToLoseFocus, m_view, nullptr);

    m_urlNavigatorVisualState = m_urlNavigatorConnected->visualState();
    m_urlNavigatorConnected = nullptr;
}

void Lion ExplorerViewContainer::setSearchBarVisible(bool visible)
{
    if (!visible) {
    ...
    if (!m_searchBar) {
        m_searchBar = new Search::Bar(std::make_shared<const Search::Lion ExplorerQuery>(m_urlNavigator->locationUrl(), QUrl{} /** will be set below. */), this);
        ...
        connect(m_searchBar, &Search::Bar::focusViewRequest, this, &Lion ExplorerViewContainer::requestFocus);
        ...
        connect(m_searchBar,
                ...
                [this](const QString &currentlyRunningTaskTitle, int installationProgressPercent) {
                    m_statusBar->showProgress(currentlyRunningTaskTitle, installationProgressPercent, Lion ExplorerStatusBar::CancelLoading::Disallowed);
                });
        connect(m_searchBar, &Search::Bar::visibilityChanged, this, &Lion ExplorerViewContainer::searchBarVisibilityChanged);
    ...
    // the user starts a search from there. Let's figure out the search location in this method and let the Lion ExplorerQuery constructor figure out the rest from
    ...
    for (int i = m_urlNavigator->historyIndex(); i < m_urlNavigator->historySize(); i++) {
        ...
        if (isSearchUrl(url)) {
            ...
            const auto searchPath = Search::Lion ExplorerQuery(url, QUrl{}).searchPath(); // Lion ExplorerQuery is great at extracting the search path from a search URL.
            if (searchPath.isValid()) {
                m_searchBar->updateStateToMatch(std::make_shared<const Search::Lion ExplorerQuery>(m_urlNavigator->locationUrl(), searchPath));
                return;
            }
        } else if (url.scheme() == QLatin1String("tags")) {
            continue; // We avoid setting a tags url as the backup search path because a Lion ExplorerQuery constructed from a tags url will already search tagged
                      // items everywhere.
        } else {
            m_searchBar->updateStateToMatch(std::make_shared<const Search::Lion ExplorerQuery>(m_urlNavigator->locationUrl(), url));
            return;
        }
    }
    ...
    m_searchBar->updateStateToMatch(std::make_shared<const Search::Lion ExplorerQuery>(m_urlNavigator->locationUrl(), QUrl::fromUserInput(QDir::homePath())));
}

bool Lion ExplorerViewContainer::isSearchBarVisible() const
{
    return m_searchBar && m_searchBar->isVisible() && m_searchBar->isEnabled();
}

void Lion ExplorerViewContainer::setFocusToSearchBar()
{
    Q_ASSERT(isSearchBarVisible());
    m_searchBar->selectAll();
}

void Lion ExplorerViewContainer::setSelectionModeEnabled(bool enabled, KActionCollection *actionCollection, SelectionMode::BottomBar::Contents bottomBarContents)
{
    ...
    if (!m_selectionModeTopBar) {
        ...
        connect(m_urlNavigator.get(), &Lion ExplorerUrlNavigator::urlChanged, this, [this]() {
    ...
    if (!m_selectionModeBottomBar) {
        ...
        connect(m_view, &Lion ExplorerView::selectionChanged, this, [this](const KFileItemList &selection) {
            m_selectionModeBottomBar->slotSelectionChanged(selection, m_view->url());
        });
        connect(m_selectionModeBottomBar, &SelectionMode::BottomBar::error, this, &Lion ExplorerViewContainer::showErrorMessage);
...
bool Lion ExplorerViewContainer::isSelectionModeEnabled() const
{
...
void Lion ExplorerViewContainer::slotSplitTabDisabled()
{
    if (m_selectionModeBottomBar) {
...
void Lion ExplorerViewContainer::showMessage(const QString &message, KMessageWidget::MessageType messageType, std::initializer_list<QAction *> buttonActions)
{
    if (message.isEmpty()) {
        return;
    }
...
void Lion ExplorerViewContainer::showProgress(const QString &currentlyRunningTaskTitle, int progressPercent)
{
    m_statusBar->showProgress(currentlyRunningTaskTitle, progressPercent, Lion ExplorerStatusBar::CancelLoading::Disallowed);
}

void Lion ExplorerViewContainer::readSettings()
{
...
bool Lion ExplorerViewContainer::isFilterBarVisible() const
{
    return m_filterBar->isEnabled(); // Gets disabled in AnimatedHeightWidget while animating towards a hidden state.
}

QString Lion ExplorerViewContainer::placesText() const
{
    QString text;
...
void Lion ExplorerViewContainer::reload()
{
    view()->reload();
    m_messageWidget->hide();
}

QString Lion ExplorerViewContainer::captionWindowTitle() const
{
    if (GeneralSettings::showFullPathInTitlebar() && (!isSearchBarVisible() || !m_searchBar->isSearchConfigured())) {
        ...
        return Lion ExplorerViewContainer::caption();
    }
}

QString Lion ExplorerViewContainer::caption() const
{
...
void Lion ExplorerViewContainer::setUrl(const QUrl &newUrl)
{
...
void Lion ExplorerViewContainer::setFilterBarVisible(bool visible)
{
...
void Lion ExplorerViewContainer::delayedStatusBarUpdate()
{
...
void Lion ExplorerViewContainer::updateStatusBar()
{
...
void Lion ExplorerViewContainer::slotDirectoryLoadingStarted()
{
    if (isSearchUrl(url())) {
...
void Lion ExplorerViewContainer::slotDirectoryLoadingCompleted()
{
...
void Lion ExplorerViewContainer::slotDirectoryLoadingCanceled()
{
    m_statusBar->showProgress(QString(), 100);
    m_statusBar->setText(QString());
}

void Lion ExplorerViewContainer::slotUrlIsFileError(const QUrl &url)
{
    ...
    if (!m_openAsFile) {
        m_openAsFile = [this, item] {
            ...
            connect(action, &QAction::triggered, this, [this, item]() {
                ...
                const QUrl &folderUrl = Lion ExplorerView::openItemAsFolderUrl(item, true);
...
void Lion ExplorerViewContainer::slotItemActivated(const KFileItem &item)
{
    ...
    const QUrl &url = Lion ExplorerView::openItemAsFolderUrl(item, GeneralSettings::browseThroughArchives());
    if (!url.isEmpty()) {
        ...
        if (modifiers & Qt::ControlModifier && modifiers & Qt::ShiftModifier) {
            ...
            Lion Explorer::openNewWindow({KFilePlacesModel::convertedUrl(url)}, this);
        } else {
            setUrl(url);
        }
        return;
    ...
    connect(job, &KIO::OpenUrlJob::finished, this, &Lion ExplorerViewContainer::slotOpenUrlFinished);
    job->start();
}

void Lion ExplorerViewContainer::slotfileMiddleClickActivated(const KFileItem &item)
{
...
void Lion ExplorerViewContainer::slotItemsActivated(const KFileItemList &items)
{
...
void Lion ExplorerViewContainer::showItemInfo(const KFileItem &item)
{
    if (item.isNull()) {
...
void Lion ExplorerViewContainer::closeFilterBar()
{
...
void Lion ExplorerViewContainer::clearFilterBar()
{
    m_filterBar->clearIfUnlocked();
}

void Lion ExplorerViewContainer::setNameFilter(const QString &nameFilter)
{
    m_view->hideToolTip(ToolTipManager::HideBehavior::Instantly);
...
void Lion ExplorerViewContainer::setFilterMode(const KFileItemModelFilter::FilterMode mode)
{
    m_view->setFilterMode(mode);
    delayedStatusBarUpdate();
}

void Lion ExplorerViewContainer::setFilterCaseSensitive(const bool caseSensitive)
{
    m_view->setFilterCaseSensitive(caseSensitive);
    delayedStatusBarUpdate();
}

void Lion ExplorerViewContainer::activate()
{
    setActive(true);
}

void Lion ExplorerViewContainer::slotUrlNavigatorLocationAboutToBeChanged(const QUrl &)
{
    saveViewState();
}

void Lion ExplorerViewContainer::slotUrlNavigatorLocationChanged(const QUrl &url)
{
    if (m_urlNavigatorConnected) {
    ...
    if (KProtocolManager::supportsListing(url)) {
        ...
        if (m_grabFocusOnUrlChange && isActive()) {
            ...
            // a new view widget.
            QTimer::singleShot(0, this, &Lion ExplorerViewContainer::requestFocus);
        }
    } else if (KProtocolManager::isSourceProtocol(url)) {
        if (url.scheme().startsWith(QLatin1String("http"))) {
            showMessage(i18nc("@info:status", // krazy:exclude=qmethods
                              "Lion Explorer does not support web pages, the web browser has been launched"),
                        KMessageWidget::Information);
        } else {
            showMessage(i18nc("@info:status", "Protocol not supported by Lion Explorer, default application has been launched"), KMessageWidget::Information);
        }
...
void Lion ExplorerViewContainer::slotUrlSelectionRequested(const QUrl &url)
{
    m_view->markUrlsAsSelected({url});
    m_view->markUrlAsCurrent(url); // makes the item scroll into view
}

void Lion ExplorerViewContainer::disableUrlNavigatorSelectionRequests()
{
    disconnect(m_urlNavigator.get(), &KUrlNavigator::urlSelectionRequested, this, &Lion ExplorerViewContainer::slotUrlSelectionRequested);
}

void Lion ExplorerViewContainer::enableUrlNavigatorSelectionRequests()
{
    connect(m_urlNavigator.get(), &KUrlNavigator::urlSelectionRequested, this, &Lion ExplorerViewContainer::slotUrlSelectionRequested);
}

void Lion ExplorerViewContainer::redirect(const QUrl &oldUrl, const QUrl &newUrl)
{
    Q_UNUSED(oldUrl)
    ...
    // Before emitting `urlChanged`, temporarily disconnect the `activated` signal to avoid activation of `Lion ExplorerViewContainer`.
    ...
    if (blockActivation) {
        connect(m_urlNavigatorConnected, &Lion ExplorerUrlNavigator::activated, this, &Lion ExplorerViewContainer::activate);

        // Force inactivate `Lion ExplorerUrlNavigator`.
        m_urlNavigatorConnected->setActive(false);
    }
}

void Lion ExplorerViewContainer::requestFocus()
{
    m_view->setFocus();
}

void Lion ExplorerViewContainer::stopDirectoryLoading()
{
    m_view->stopLoading();
    m_statusBar->showProgress(QString(), 100);
}

void Lion ExplorerViewContainer::slotStatusBarZoomLevelChanged(int zoomLevel)
{
    m_view->setZoomLevel(zoomLevel);
}

bool Lion ExplorerViewContainer::isTopMostExistingParentFolderWritable(QUrl url)
{
...
void Lion ExplorerViewContainer::slotErrorMessageFromView(const QString &message, const int kioErrorCode)
{
...
void Lion ExplorerViewContainer::showErrorMessage(const QString &message)
{
    showMessage(message, KMessageWidget::Error);
}

void Lion ExplorerViewContainer::slotPlacesModelChanged()
{
...
void Lion ExplorerViewContainer::slotHiddenFilesShownChanged(bool showHiddenFiles)
{
    if (m_urlNavigatorConnected) {
...
void Lion ExplorerViewContainer::slotSortHiddenLastChanged(bool hiddenLast)
{
    if (m_urlNavigatorConnected) {
...
void Lion ExplorerViewContainer::slotCurrentDirectoryRemoved()
{
...
void Lion ExplorerViewContainer::slotOpenUrlFinished(KJob *job)
{
...
void Lion ExplorerViewContainer::saveViewState()
{
...
void Lion ExplorerViewContainer::tryRestoreViewState()
{
...
QString Lion ExplorerViewContainer::getNearestExistingAncestorOfPath(const QString &path) const
{
    QDir dir(path);
    do {
...
void Lion ExplorerViewContainer::updateStatusBarGeometry()
{
    if (!m_statusBar) {
        return;
    }
...
bool Lion ExplorerViewContainer::eventFilter(QObject *object, QEvent *event)
{
...
QRect Lion ExplorerViewContainer::preferredSmallStatusBarGeometry()
{
...
#include "moc_lionexplorerviewcontainer.cpp"
