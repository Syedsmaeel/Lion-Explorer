...
#ifndef lionexplorerpackageinstaller_H
#define lionexplorerpackageinstaller_H
 ...
 */
class Lion ExplorerPackageInstaller : public KJob
{
public:
    /**
     ...
     * @param fallBackInstallationPageUrl   This url will be opened if Lion Explorer was installed without the PackageKit library. A good choice for this parameter
     ...
     */
    explicit Lion ExplorerPackageInstaller(const QString &packageName,
...
private:
     ...
     * For progress reporting this method will use Lion ExplorerPackageInstaller::connectTransactionToJobProgress().
...
private:
    ...
    /** @see Lion ExplorerPackageInstaller::Lion ExplorerPackageInstaller(). */
...
#endif // lionexplorerpackageinstaller_H
