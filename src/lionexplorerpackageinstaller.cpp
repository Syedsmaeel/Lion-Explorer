...
#include "lionexplorerpackageinstaller.h"
...
Lion ExplorerPackageInstaller::Lion ExplorerPackageInstaller(const QString &packageName,
...
void Lion ExplorerPackageInstaller::start()
{
    ...
    connect(resolveTransaction, &PackageKit::Transaction::errorCode, this, &Lion ExplorerPackageInstaller::slotInstallationFailed);
...
#if HAVE_PACKAGEKIT
void Lion ExplorerPackageInstaller::install(const QString &packageId)
{
...
void Lion ExplorerPackageInstaller::connectTransactionToJobProgress(const PackageKit::Transaction &transaction)
{
...
void Lion ExplorerPackageInstaller::slotInstallationFailed(PackageKit::Transaction::Error error, const QString &details)
{
