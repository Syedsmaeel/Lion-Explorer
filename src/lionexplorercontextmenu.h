...
#ifndef LIONEXPLORERCONTEXTMENU_H
#define LIONEXPLORERCONTEXTMENU_H
 ...
 *                given item.
 */
class Lion ExplorerContextMenu : public QMenu
{
    Q_OBJECT
...
public:
     ...
     *                should be opened.
     */
    Lion ExplorerContextMenu(Lion ExplorerMainWindow *parent,
                       const KFileItem &fileInfo,
                       const KFileItemList &selectedItems,
                       const QUrl &baseUrl,
                       KFileItemActions *fileItemActions);

    ~Lion ExplorerContextMenu() override;
...
private:
    ...
    Lion ExplorerRemoveAction *m_removeAction; // Action that represents either 'Move To Trash' or 'Delete'
