...
#ifndef LIONEXPLORERNAVIGATORSWIDGETACTION_H
#define LIONEXPLORERNAVIGATORSWIDGETACTION_H
...
/**
 * @brief QWidgetAction that allows to use Lion ExplorerUrlNavigators in a toolbar.
 *
 * This class is mainly a container that manages up to two Lion ExplorerUrlNavigator objects so they
 ...
 * - A QSplitter manages up to two sides which each correspond to one Lion ExplorerViewContainer.
 ...
 *      The spacing is there to align the UrlNavigator with its Lion ExplorerViewContainer.
 */
class Lion ExplorerNavigatorsWidgetAction : public QWidgetAction
{
    Q_OBJECT

public:
    Lion ExplorerNavigatorsWidgetAction(QWidget *parent = nullptr);
     ...
     */
    Lion ExplorerUrlNavigator *primaryUrlNavigator() const;
    /**
     * @return the secondary UrlNavigator and nullptr if it doesn't exist.
     */
    Lion ExplorerUrlNavigator *secondaryUrlNavigator() const;
...
private:
     ...
     */
    QPushButton *newEmptyTrashButton(const Lion ExplorerUrlNavigator *urlNavigator, QWidget *parent) const;
     ...
     */
    QPushButton *newNetworkFolderButton(const Lion ExplorerUrlNavigator *urlNavigator, QWidget *parent) const;
     ...
     * @param parent       The object that should be the button's parent.
     */
    QPushButton *newKdeConnectButton(const Lion ExplorerUrlNavigator *urlNavigator, QWidget *parent) const;
    ...
    public:
         ...
         *                               deemed necessary.
         */
        ViewGeometriesHelper(QWidget *navigatorsWidget, Lion ExplorerNavigatorsWidgetAction *navigatorsWidgetAction);
    ...
    private:
        ...
        Lion ExplorerNavigatorsWidgetAction *m_navigatorsWidgetAction;
...
#endif // LIONEXPLORERNAVIGATORSWIDGETACTION_H
