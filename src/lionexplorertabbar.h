...
#ifndef LIONEXPLORER_TAB_BAR_H
#define LIONEXPLORER_TAB_BAR_H

#include <QTabBar>

class Lion ExplorerTabBar : public QTabBar
{
    Q_OBJECT

public:
    explicit Lion ExplorerTabBar(QWidget *parent);
