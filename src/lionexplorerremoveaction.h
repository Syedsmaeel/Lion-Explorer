...
#ifndef LIONEXPLORERREMOVEACTION_H
#define LIONEXPLORERREMOVEACTION_H
 ...
 */
class LIONEXPLORER_EXPORT Lion ExplorerRemoveAction : public QAction
{
    Q_OBJECT
public:
    enum class ShiftState { Unknown, Pressed, Released };

    Lion ExplorerRemoveAction(QObject *parent, KActionCollection *collection);
